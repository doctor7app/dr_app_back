...
namespace Dme.Dtos.Treatments;

public class TreatmentsCreateDto : IMapFrom<Domain.Models.Treatments>
{
    ...
    {
        profile.CreateMap<TreatmentsCreateDto, Domain.Models.Treatments>()
